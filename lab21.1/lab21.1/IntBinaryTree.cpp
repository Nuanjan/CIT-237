...
lSubTreeHeight = calculateSubTreeHeight(nodePtr->left);
rSubTreeHeight= calculateSubTreeHeight(nodePtr->right);

if (lSubTreeHeight > rSubTreeHeight) {
	retun lSubTreeHeight + 1;
}
else {
...
void IntBinaryTree::displayTreeHeight() const
{
	...
	cout << "Height of tree = " << treeHeight;  //PROBLEM!!!!! get height =0
